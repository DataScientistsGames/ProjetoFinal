...
$(BUILD_DIR)/Controlador.o: $(INCLUDE_DIR)/Controlador.hpp $(INCLUDE_DIR)/Cadastrador.hpp $(INCLUDE_DIR)/Comandos.hpp $(INCLUDE_DIR)/Jogador.hpp $(INCLUDE_DIR)/Tabuleiro.hpp $(INCLUDE_DIR)/Reversi.hpp $(INCLUDE_DIR)/Lig4.hpp $(INCLUDE_DIR)/Velha.hpp $(INCLUDE_DIR)/Partida.hpp $(SRC_DIR)/Controlador.cpp | $(BUILD_DIR)
...
$(BIN_DIR)/sistema: $(BUILD_DIR)/main.o $(BUILD_DIR)/Controlador.o $(BUILD_DIR)/CSV.o $(BUILD_DIR)/Cadastrador.o $(BUILD_DIR)/Jogador.o $(BUILD_DIR)/Tabuleiro.o $(BUILD_DIR)/Reversi.o $(BUILD_DIR)/Lig4.o $(BUILD_DIR)/Velha.o $(BUILD_DIR)/Partida.o $(BUILD_DIR)/PosicaoCartesiana.o
	$(CC) $(CFLAGS) $(BUILD_DIR)/main.o $(BUILD_DIR)/Controlador.o $(BUILD_DIR)/CSV.o $(BUILD_DIR)/Cadastrador.o $(BUILD_DIR)/Jogador.o $(BUILD_DIR)/Tabuleiro.o $(BUILD_DIR)/Reversi.o $(BUILD_DIR)/Lig4.o $(BUILD_DIR)/Velha.o $(BUILD_DIR)/Partida.o $(BUILD_DIR)/PosicaoCartesiana.o -o $(BIN_DIR)/sistema
