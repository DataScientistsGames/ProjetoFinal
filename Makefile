...
$(BUILD_DIR)/Controlador.o: $(INCLUDE_DIR)/Controlador.hpp $(INCLUDE_DIR)/$(HELPERS_DIR)/CoutComuns.hpp $(INCLUDE_DIR)/Estatistica.hpp $(INCLUDE_DIR)/Cadastrador.hpp $(INCLUDE_DIR)/Comandos.hpp $(INCLUDE_DIR)/Jogador.hpp $(INCLUDE_DIR)/Tabuleiro.hpp $(INCLUDE_DIR)/Reversi.hpp $(INCLUDE_DIR)/Lig4.hpp $(INCLUDE_DIR)/Velha.hpp $(INCLUDE_DIR)/Partida.hpp $(SRC_DIR)/Controlador.cpp | $(BUILD_DIR)
...
$(BUILD_DIR)/Partida.o: $(INCLUDE_DIR)/Partida.hpp $(INCLUDE_DIR)/$(HELPERS_DIR)/CSV.hpp $(INCLUDE_DIR)/$(HELPERS_DIR)/CoutComuns.hpp $(INCLUDE_DIR)/Jogador.hpp $(INCLUDE_DIR)/Tabuleiro.hpp $(INCLUDE_DIR)/PosicaoCartesiana.hpp $(INCLUDE_DIR)/Reversi.hpp $(INCLUDE_DIR)/Lig4.hpp $(INCLUDE_DIR)/Velha.hpp $(SRC_DIR)/Partida.cpp | $(BUILD_DIR)
...
$(BUILD_DIR)/Estatistica.o: $(INCLUDE_DIR)/Estatistica.hpp $(INCLUDE_DIR)/Jogador.hpp $(INCLUDE_DIR)/$(HELPERS_DIR)/CSV.hpp $(SRC_DIR)/Estatistica.cpp | $(BUILD_DIR)
